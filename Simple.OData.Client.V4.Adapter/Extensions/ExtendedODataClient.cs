...
namespace Simple.OData.Client.V4.Adapter.Extensions
{
    ...
    public class ExtendedODataClient : IExtendedODataClient
    {
        ...
        {
            var client = new ExtendedBoundClient<IDictionary<string, object>>(_baseClient, _baseClient.Session as Session);
        ...
        {
            var client = new ExtendedBoundClient<ODataEntry>(_baseClient, _baseClient.Session as Session, true);
        ...
        {
            var client = new ExtendedBoundClient<T>(_baseClient, _baseClient.Session as Session);
            client.For(collectionName);
            return client;
        }
    }
