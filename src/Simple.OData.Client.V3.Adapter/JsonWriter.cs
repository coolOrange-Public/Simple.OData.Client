...
using IJsonWriter = Simple.OData.Client.Adapter.IJsonWriter;
...
namespace Simple.OData.Client.V3.Adapter
{
	public class JsonWriter : IJsonWriter
	{
		...
		private static readonly Assembly MicrosoftOdataAssembly = Assembly.GetAssembly(typeof(Microsoft.Data.OData.ODataEntry));
		...
		public void WriteJsonValue(object propertyValue)
		{
			var writeJsonValue = MicrosoftOdataAssembly.GetType("Microsoft.Data.OData.Json.JsonWriterExtensions")
				.GetMethod("WriteJsonValue", BindingFlags.NonPublic | BindingFlags.Static, null, CallingConventions.Any,
