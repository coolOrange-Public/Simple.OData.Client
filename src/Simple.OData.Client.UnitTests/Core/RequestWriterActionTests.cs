...
namespace Simple.OData.Client.Tests.Core
{
	public class RequestWriterActionTests : CoreTestBase
	{
		...
		{
			get { return "ActionWithDerivedType.xml"; }
		}
		...
		protected async Task<IRequestWriter> CreateRequestWriter()
		{
			return new V4.Adapter.RequestWriter(_session,
				await _client.GetMetadataAsync<Microsoft.OData.Edm.IEdmModel>(), null);
		}
						...
						"OrderClose", new Dictionary<string, object> {
							{
								"salesorderid",
								new Dictionary<string, object>
									{ { "salesorderid", new Guid("5AEEC23F-DB4F-E911-A978-000D3A3611E1") } }
							},
							{ "subject", string.Format("Close sales Order {0}", DateTime.Now) },
