...
namespace Simple.OData.Client.Tests.Core
{
	public abstract class CoreTestBase : IDisposable
	{
		...
		public static string GetResourceAsString(string resourceName)
		{
			...
			var completeResourceName = resourceNames.FirstOrDefault(o =>
				o.EndsWith("." + resourceName, StringComparison.CurrentCultureIgnoreCase));
		...
		public static IODataResponseMessageAsync SetUpResourceMock(string resourceName)
		{
			...
			mock.Setup(x => x.GetHeader("Content-Type"))
				.Returns(() => "application/atom+xml; type=feed; charset=utf-8");
			return mock.Object;
		}
	}
}