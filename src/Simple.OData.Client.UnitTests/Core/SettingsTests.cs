	...
	public class SettingsTests
	{
		...
		public void CtorWithHttpClientNoBaseAddressAndRelativeUri()
		{
			Assert.Throws<ArgumentException>(() =>
				new ODataClientSettings(new HttpClient(), new Uri("api", UriKind.Relative)));
		}
		...
		{
			Assert.Throws<ArgumentException>(() =>
				new ODataClientSettings(new HttpClient { BaseAddress = new Uri("abc", UriKind.Relative) }));
		}
		...
		{
			Assert.Throws<ArgumentException>(() =>
				new ODataClientSettings(new HttpClient { BaseAddress = new Uri("http://localhost") },
