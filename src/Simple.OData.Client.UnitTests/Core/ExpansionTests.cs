...
namespace Simple.OData.Client.Tests.Core
{
	public class ExpansionTests : CoreTestBase
	{
		...
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates/Subordinates&$select=LastName,Subordinates,Subordinates/LastName,Subordinates/Subordinates")]
		[InlineData("Northwind4.xml",
			"Employees?$expand=Subordinates($expand=Subordinates;$select=LastName)&$select=LastName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates/Subordinates&$select=LastName,Subordinates,Subordinates/LastName,Subordinates/Subordinates&$orderby=LastName,Subordinates/LastName")]
		[InlineData("Northwind4.xml",
			"Employees?$expand=Subordinates($expand=Subordinates;$select=LastName;$orderby=LastName)&$select=LastName&$orderby=LastName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates/*&$select=LastName,Subordinates,Subordinates/LastName,Subordinates/Subordinates&$orderby=LastName,Subordinates/LastName")]
		[InlineData("Northwind4.xml",
			"Employees?$expand=Subordinates($expand=*;$select=LastName;$orderby=LastName)&$select=LastName&$orderby=LastName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates/Subordinates/Subordinates&$select=LastName,Subordinates,Subordinates/LastName,Subordinates/Subordinates,Subordinates/Subordinates/LastName,Subordinates/Subordinates/Subordinates&$orderby=LastName,Subordinates/LastName,Subordinates/Subordinates/LastName")]
		[InlineData("Northwind4.xml",
			"Employees?$expand=Subordinates($expand=Subordinates($expand=Subordinates;$select=LastName;$orderby=LastName);$select=LastName;$orderby=LastName)&$select=LastName&$orderby=LastName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates/Subordinates/*&$select=LastName,Subordinates,Subordinates/LastName,Subordinates/Subordinates,Subordinates/Subordinates/LastName,Subordinates/Subordinates/Subordinates&$orderby=LastName,Subordinates/LastName,Subordinates/Subordinates/LastName")]
		[InlineData("Northwind4.xml",
			"Employees?$expand=Subordinates($expand=Subordinates($expand=*;$select=LastName;$orderby=LastName);$select=LastName;$orderby=LastName)&$select=LastName&$orderby=LastName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Employees?$expand=Subordinates&$select=LastName,Subordinates&$orderby=Superior/LastName")]
		...
		public async Task ExpandSuperiorWithSubordinatesAndSuperiorInMultipleExpands(string metadataFile,
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Products?$expand=Category&$select=ProductName,Category/CategoryName&$orderby=Category/CategoryName")]
		[InlineData("Northwind4.xml",
			"Products?$expand=Category($select=CategoryName)&$select=ProductName&$orderby=Category/CategoryName")]
		public async Task ExpandCategorySelectProductNameCategoryNameThenOrderBy(string metadataFile,
			string expectedCommand)
		{
			var client = CreateClient(metadataFile);
			var command = client.For<Product>()
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Products?$expand=*&$select=ProductName,Category/CategoryName&$orderby=Category/CategoryName")]
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Products?$expand=Category&$select=ProductName,Category/CategoryName&$orderby=Category/CategoryName,ProductName")]
		[InlineData("Northwind4.xml",
			"Products?$expand=Category($select=CategoryName)&$select=ProductName&$orderby=Category/CategoryName,ProductName")]
		public async Task ExpandCategorySelectProductNameCategoryNameThenOrderByCategoryNameThenByProductName(
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Products?$expand=*&$select=ProductName,Category/CategoryName&$orderby=Category/CategoryName,ProductName")]
		[InlineData("Northwind4.xml",
			"Products?$expand=*&$select=ProductName&$orderby=Category/CategoryName,ProductName")]
		public async Task ExpandAllSelectProductNameCategoryNameThenOrderByCategoryNameThenByProductName(
			string metadataFile, string expectedCommand)
		{
			var client = CreateClient(metadataFile);
			var command = client.For<Product>()
		...
		[Theory]
		[InlineData("Northwind3.xml",
			"Order_Details?$expand=Order&$select=OrderID,Quantity,rde,Order/OrderDate&$orderby=Order/OrderDate,Quantity")]
		[InlineData("Northwind4.xml",
			"Order_Details?$expand=Order($select=OrderDate)&$select=OrderID,Quantity,rde&$orderby=Order/OrderDate,Quantity")]
		public async Task ExpandNavigationPropertyAndPropertyWithContainedName_Issue801(string metadataFile,
			string expectedCommand)
		{
			var client = CreateClient(metadataFile);
		...
		public async Task ExpandFunction()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"People(%27scottketchum%27)/Trips(0)/Microsoft.OData.SampleService.Models.TripPin.GetInvolvedPeople()?$expand=Photo",
				commandText);
		}
		...
		public async Task ExpandSuperiorWithSubordinatesAndTheirSuperiorsAndDeepOrderby()
		{
			const string expectedCommand =
				"Employees?$expand=Superior($expand=Subordinates($expand=Superior;$orderby=LastName))";
			var client = CreateClient("Northwind4.xml");
			var command = client.For<Employee>()
		...
		[Fact]
		public async Task
			ExpandProductsSelectProductNameAndUnitPriceThenOrderByUnitPriceDescendingThenByProductNameDescending()
		{
			var client = CreateClient("Northwind4.xml");
			var command = client
				.For<Category>()
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Categories?$expand=Products($select=ProductName,UnitPrice;$orderby=UnitPrice desc,ProductName desc)",
				commandText);
		}
	}
}