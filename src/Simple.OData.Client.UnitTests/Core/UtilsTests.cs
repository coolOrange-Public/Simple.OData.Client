...
namespace Simple.OData.Client.Tests.Core
{
	public class UtilsTests
	{
		...
		[InlineData("http://company.com", "Products?$filter=Id%20eq%201",
			"http://company.com/Products?$filter=Id%20eq%201")]
		[InlineData("http://company.com/feed", "Products?$filter=Id%20eq%201",
			"http://company.com/feed/Products?$filter=Id%20eq%201")]
		[InlineData("http://company.com?client=100", "Products?$filter=Id%20eq%201",
			"http://company.com/Products?$filter=Id%20eq%201&client=100")]
		[InlineData("http://company.com/feed?client=100", "Products?$filter=Id%20eq%201",
			"http://company.com/feed/Products?$filter=Id%20eq%201&client=100")]
