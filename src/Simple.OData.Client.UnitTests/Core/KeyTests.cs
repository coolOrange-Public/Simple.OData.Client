...
namespace Simple.OData.Client.Tests.Core
{
	public class KeyTests : CoreTestBase
	{
		public override string MetadataFile
		{
			get
			{
				return "Northwind4WithAlternateKeys.xml";
			}
		}
		...
		[InlineData("Northwind4WithAlternateKeys.xml",
			"Categories?$filter=CategoryID%20eq%201%20and%20CategoryName%20eq%20%27Test%27")]
		...
		[InlineData("Northwind3.xml",
			"Employees?$filter=HomePhone%20eq%20%27123%27%20and%20Title%20eq%20%27Manager%27")]
		[InlineData("Northwind4WithAlternateKeys.xml", "Employees(HomePhone=%27123%27,Title=%27Manager%27)")]
