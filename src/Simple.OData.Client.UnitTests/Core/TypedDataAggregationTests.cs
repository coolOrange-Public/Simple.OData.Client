...
namespace Simple.OData.Client.Tests.FluentApi
{
	public class TypedDataAggregationTests : CoreTestBase
	{
		...
		public async Task Filter()
		{
			...
			Assert.Equal(
				"Products?$apply=filter%28contains%28ProductName%2C%27ai%27%29%20and%20startswith%28ProductName%2C%27Ch%27%29%29",
				commandText);
		}
		...
		public async Task AggregateWithAverage()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal("Products?$apply=aggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregation()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationAndNestedAssignments()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28ProductName%2CCategory%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationOfMultipleProperties()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%2C%24count%20as%20Count%29%29",
				commandText);
		}
		...
		public async Task FilterThenGroupByWithAggregationAsConcreteDestinationType()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=filter%28%28Category%2FCategoryName%20in%20%28%27Beverage%27%2C%27Food%27%29%29%29%2Fgroupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationThenFilter()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20max%20as%20MaxUnitPrice%29%29%2Ffilter%28MaxUnitPrice%20gt%20100%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationThenAggregate()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29%2Faggregate%28AverageUnitPrice%20with%20max%20as%20MaxPrice%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationThenGroupByWithAggregation()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29%2Fgroupby%28%28AverageUnitPrice%29%2Caggregate%28%24count%20as%20CategoriesCount%29%29",
				commandText);
		}
		...
		public async Task GroupByWithAggregationThenOrderBy()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=groupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29&$orderby=AverageUnitPrice",
				commandText);
		}
		...
		public async Task MultipleApplies()
		{
			...
			var commandText = await command.GetCommandTextAsync();
			Assert.Equal(
				"Products?$apply=filter%28contains%28Category%2FCategoryName%2C%27v%27%29%29%2Fgroupby%28%28Category%2FCategoryName%29%2Caggregate%28UnitPrice%20with%20average%20as%20AverageUnitPrice%29%29%2Ffilter%28AverageUnitPrice%20gt%20100%29",
				commandText);
		}
	}
