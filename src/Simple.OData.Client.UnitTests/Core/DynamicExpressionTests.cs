...
namespace Simple.OData.Client.Tests.Core
{
	...
	public abstract class DynamicExpressionTests : CoreTestBase
	{
		...
		public void GreaterOrEqualNumeric()
		{
			...
			Assert.Equal(string.Format("CategoryID ge 1.5{0}", FormatSettings.DoubleNumberSuffix),
		...
		public void EqualLong()
		{
			...
			Assert.Equal(string.Format("CategoryID eq 1{0}", FormatSettings.LongNumberSuffix),
				filter.AsString(_session));
		}
		...
		public void EqualDecimalWithFractionalPart()
		{
			...
			Assert.Equal(string.Format("Total eq 1.23{0}", FormatSettings.DecimalNumberSuffix),
				filter.AsString(_session));
		}
		...
		public void FilterWithEnum()
		{
			...
			Assert.Equal(string.Format("Address/Type eq {0}",
