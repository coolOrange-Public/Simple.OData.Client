...
namespace Simple.OData.Client.Tests.Core
{
	public interface IFormatSettings
	{
		...
		string GetEnumFormat(object value, Type enumType, string ns, bool prefixFree = false,
	...
	internal class ODataV3Format : IFormatSettings
	{
		...
		public string GetEnumFormat(object value, Type enumType, string ns, bool prefixFree = false,
			bool escapeString = false)
		{
