...
namespace Simple.OData.Client.Adapter
{
	...
	public class MetadataCache : IMetadata
	{
		...
		public bool IgnoreUnmappedProperties { get; private set; }

		public bool HasStream(string collectionName)
		{
			return metadata.HasStream(collectionName);
		}

		public string GetNavigationPropertyMultiplicity(string collectionName, string propertyName)
		{
			return metadata.GetNavigationPropertyMultiplicity(collectionName, propertyName);
		}

		public string GetNavigationPropertyPartnerMultiplicity(string collectionName, string propertyName)
		{
			return metadata.GetNavigationPropertyPartnerMultiplicity(collectionName, propertyName);
		}

		public bool PropertyIsNullable(string collectionName, string propertyName)
		{
			return metadata.PropertyIsNullable(collectionName, propertyName);
		}

		public string GetPropertyDefaultValue(string collectionName, string propertyName)
		{
			return metadata.GetPropertyDefaultValue(collectionName, propertyName);
		}

		public Type GetPropertyType(string collectionName, string propertyName)
		{
			return metadata.GetPropertyType(collectionName, propertyName);
		}

		public string GetEntityTypeName(string entitySetName)
		{
			return metadata.GetEntityTypeName(entitySetName);
		}

		public IEnumerable<string> GetPropertyNames(string collectionName)
		{
			return metadata.GetPropertyNames(collectionName);
		}

		public IEnumerable<string> GetEntitySetNames()
		{
			return metadata.GetEntitySetNames();
		}

		public IEnumerable<string> GetEntityTypeNames()
		{
			return metadata.GetEntityTypeNames();
		}
