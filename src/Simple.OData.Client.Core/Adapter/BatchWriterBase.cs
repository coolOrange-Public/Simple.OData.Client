...
namespace Simple.OData.Client
{
	public abstract class BatchWriterBase : IBatchWriter
	{
		...
		protected abstract Task<object> CreateOperationMessageAsync(Uri uri, string method, string collection,
		...
		public async Task<object> CreateOperationMessageAsync(Uri uri, string method, string collection,
		...
		protected HttpRequestMessage CreateMessageFromStream(Stream stream, Uri requestUrl,
