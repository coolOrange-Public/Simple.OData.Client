...
namespace Simple.OData.Client
{
	public abstract class MetadataBase : IMetadata
	{
		...
		public abstract IEnumerable<string> GetPropertyNames(string collectionName);
		public abstract string GetEntityTypeName(string entitySetName);

		public bool IgnoreUnmappedProperties { get; private set; }
		public INameMatchResolver NameMatchResolver { get; private set; }
		public bool UnqualifiedNameCall { get; private set; }
