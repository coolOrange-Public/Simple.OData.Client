...
namespace Simple.OData.Client
{
	internal interface IRequestBuilder
	{
		...
		Task<ODataRequest> InsertRequestAsync(bool deep, bool resultRequired, CancellationToken cancellationToken);
		Task<ODataRequest> UpdateRequestAsync(bool resultRequired, CancellationToken cancellationToken);

		Task<ODataRequest> UpdateRequestAsync(Stream stream, string contentType, bool optimisticConcurrency,
			CancellationToken cancellationToken);

		Task<ODataRequest> DeleteRequestAsync(CancellationToken cancellationToken);

		Task<ODataRequest> LinkRequestAsync(string linkName, IDictionary<string, object> linkedEntryKey,
			CancellationToken cancellationToken);

		Task<ODataRequest> UnlinkRequestAsync(string linkName, IDictionary<string, object> linkedEntryKey,
			CancellationToken cancellationToken);
	}
	...
	public interface IRequestBuilder<T>
	{
		...
		Task<IClientWithRequest<T>> InsertEntryAsync(bool deep, bool resultRequired,
			CancellationToken cancellationToken);
