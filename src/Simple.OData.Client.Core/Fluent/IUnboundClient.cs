...
namespace Simple.OData.Client
{
		...
		where T : class
	{
		...
		/// <param name="value">The value to update the entry with.</param>
		/// <returns>Self.</returns>
		IUnboundClient<T> Set(bool deep,params ODataExpression[] value);
		/// <summary>
		/// Sets the specified entry value for update.
		/// </summary>
		/// <param name="value">The value to update the entry with.</param>
		/// <param name="deep">The value indicates whether the entry should be created for deep insert/update</param>
		/// <returns>Self.</returns>
		IUnboundClient<T> Set(object value, bool deep = false);
		/// <summary>
		/// Sets the specified entry value for update.
		/// </summary>
		/// <param name="value">The value to update the entry with.</param>
		/// <param name="deep">The value indicates whether the entry should be created for deep insert/update</param>
		/// <returns>Self.</returns>
		IUnboundClient<T> Set(IDictionary<string, object> value, bool deep = false);
		/// <summary>
		/// Sets the specified entry value for update.
		/// </summary>
		...
		/// <param name="deep">The value indicates whether the entry should be created for deep insert/update</param>
		/// <returns>Self.</returns>
		IUnboundClient<T> Set(T entry, bool deep = false);
	}
}