...
namespace Simple.OData.Client
{
	...
	public class ODataClientSettings
	{
		...
		public Uri BaseUri
		{
			...
			set
			{
				if (value != null && value.IsAbsoluteUri && this.HttpClient != null &&
				    this.HttpClient.BaseAddress != null)
				{
					throw new InvalidOperationException(
						"Unable to set BaseUri when BaseAddress is specified on HttpClient.");
				}
		...
		{
			get { return _nameMatchResolver ?? _defaultNameMatchResolver; }
		...
		{
			get { return _adapterFactory ?? _defaultAdapterFactory; }
		...
		/// </value>
		public BatchPayloadUriOption BatchPayloadUriOption { get; set; }
			...
			: this()
		{
			if (httpClient != null && httpClient.BaseAddress != null && !httpClient.BaseAddress.IsAbsoluteUri)
				throw new ArgumentException("HttpClient BaseAddress must be an absolute URI", "httpClient");
			if (relativeUri != null && relativeUri.IsAbsoluteUri)
				throw new ArgumentException("Must be a relative URI", "relativeUri");
			if (httpClient != null && httpClient.BaseAddress == null && relativeUri != null)
				throw new ArgumentException("Must not specify relative URI when HttpClient has no BaseAddress",
					"relativeUri");
			if (httpClient == null)
