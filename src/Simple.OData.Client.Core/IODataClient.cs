...
namespace Simple.OData.Client
{
	...
	public interface IODataClient
	{
		...
		/// <returns>Entries found with entry count.</returns>
		Task<IEnumerable<IDictionary<string, object>>> FindEntriesAsync(string commandText,
			ODataFeedAnnotations annotations, IDictionary<string, string> headers, CancellationToken cancellationToken);
		...
		/// <param name="entryKey">The entry key.</param>
		/// <returns>The entry with the specified key</returns>
		Task<IDictionary<string, object>> GetEntryAsync(string collection, CancellationToken cancellationToken,
			params object[] entryKey);
		...
		Task<IDictionary<string, object>> UpdateEntryAsync(string collection, IDictionary<string, object> entryKey,
		...
		/// <returns>The updated entry data</returns>
		Task<IDictionary<string, object>> UpdateEntryAsync(string collection, IDictionary<string, object> entryKey,
			IDictionary<string, object> entryData, CancellationToken cancellationToken);
		...
		/// <returns>The updated entry data</returns>
		Task<IDictionary<string, object>> UpdateEntryAsync(string collection, IDictionary<string, object> entryKey,
			IDictionary<string, object> entryData, bool resultRequired);
		...
		/// <returns>The updated entry data</returns>
		Task<IDictionary<string, object>> UpdateEntryAsync(string collection, IDictionary<string, object> entryKey,
			IDictionary<string, object> entryData, bool resultRequired, CancellationToken cancellationToken);
		...
		Task<IEnumerable<IDictionary<string, object>>> UpdateEntriesAsync(string collection, string commandText,
			IDictionary<string, object> entryData);
		...
		/// <returns>Task instance.</returns>
		Task LinkEntryAsync(string collection, IDictionary<string, object> entryKey, string linkName,
		...
		Task<IDictionary<string, object>> ExecuteFunctionAsSingleAsync(string functionName,
		...
		/// <param name="parameters">The function parameters.</param>
		/// <returns>Function execution result.</returns>
		Task<IEnumerable<IDictionary<string, object>>> ExecuteFunctionAsEnumerableAsync(string functionName,
			IDictionary<string, object> parameters);
		...
		/// <param name="parameters">The action parameters.</param>
		/// <returns>Action execution result.</returns>
		Task<IDictionary<string, object>> ExecuteActionAsSingleAsync(string actionName,
			IDictionary<string, object> parameters);
		...
		/// <param name="parameters">The action parameters.</param>
		/// <returns>Action execution result.</returns>
		Task<IEnumerable<IDictionary<string, object>>> ExecuteActionAsEnumerableAsync(string actionName,
			IDictionary<string, object> parameters);
