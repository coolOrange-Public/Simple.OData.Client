...
namespace Simple.OData.Client
{
	public partial class ODataExpression
	{
		...
		public bool IsValueConversion
		{
			get
			{
				return _conversionType != null;
			}
		}
		...
		internal protected ODataExpression(ODataExpression left, ODataExpression right,
		...
		internal bool HasTypeConstraint(string typeName)
		{
			...
			else if (Value != null)
			{
				...
				return valueType != null && valueType.Name == typeName;
			}
			else
			{
				return false;
...

	{
		...
		public override bool Equals(object obj)
		{
			var expression = obj as ODataExpression<T>;
			return !ReferenceEquals(expression, null) &&
			       base.Equals(obj) &&
			       Reference == expression.Reference &&
			       EqualityComparer<object>.Default.Equals(Value, expression.Value) &&
