...
namespace Simple.OData.Client
{
	internal class FunctionMapping
	{
		...
		{
			public FunctionDefinition(ExpressionFunction.FunctionCall functionCall, FunctionMapping functionMapping,
		...
		private static readonly
			Func<FunctionDefinition, Func<string, ODataExpression, IEnumerable<object>, ODataExpression>>
			FunctionWithTarget =
				function =>
		...
		public static readonly FunctionDefinition[] DefinedFunctions = {
			...
			CreateFunctionDefinition("Totaloffsetminutes", 0, "totaloffsetminutes", FunctionWithTarget,
				AdapterVersion.V4),
		...
		private static FunctionDefinition CreateFunctionDefinition(string functionName, int argumentCount,
			string mappedFunctionName,
			Func<FunctionDefinition, Func<string, ODataExpression, IEnumerable<object>, ODataExpression>> mapper,
			AdapterVersion adapterVersion = AdapterVersion.Any)
		{
