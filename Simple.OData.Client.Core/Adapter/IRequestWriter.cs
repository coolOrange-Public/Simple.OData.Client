...
namespace Simple.OData.Client
{
	public interface IRequestWriter
	{
		...
		Task<ODataRequest> CreateInsertRequestAsync(string collection, string commandText, IDictionary<string, object> entryData, bool resultRequired, bool deep, IDictionary<string, string> headers = null);
