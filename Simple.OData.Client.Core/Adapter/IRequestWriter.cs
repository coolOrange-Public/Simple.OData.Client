...
namespace Simple.OData.Client
{
    public interface IRequestWriter
    {
        ...
        Task<ODataRequest> CreateInsertRequestAsync(IEnumerable<string> collection, string commandText, IDictionary<string, object> entryData, bool resultRequired);
        Task<ODataRequest> CreateUpdateRequestAsync(IEnumerable<string> collections, string entryIdent, IDictionary<string, object> entryKey, IDictionary<string, object> entryData, bool resultRequired);
