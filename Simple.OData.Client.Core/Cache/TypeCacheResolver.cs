...
namespace Simple.OData.Client
{
	...
	public class TypeCacheResolver
	{
		...
		/// </summary>
		public IList<Type> DerivedTypes { get; private set; }
		...
		public bool IsValue
		{
			get { return TypeInfo.IsValueType; }
		}
		...
		/// Gets all properties
		/// </summary>
		public IList<PropertyInfo> AllProperties { get; private set; }
		...
		/// Gets all fields
		/// </summary>
		public IList<FieldInfo> AllFields { get; private set; }
		...
		/// </summary>
		public IList<PropertyInfo> MappedProperties { get; private set; }

		/// <summary>
		/// Gets mapped properties with the mapped name
		/// </summary>
		public IList<Tuple<PropertyInfo, string>> MappedPropertiesWithNames { get; private set; }
